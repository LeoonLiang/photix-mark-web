  ...
  processors: [
    {
      ...
      sections: [
        ...
        // 顶部 Logo 条
        {
          ...
          background: 'white',
          logo_size: 0.7,
          logo_vertical_align: 1,  // ✨ Logo 靠近底部（0-1，0=顶部，0.5=居中，1=底部，默认 0.5）
        },
        // 底部信息条
        {
          type: 'info_bar',
          ...
          show_camera: true,
          show_params: true,
          brand_vertical_align: 0,   // ✨ 品牌型号靠近顶部（默认 0.3）
          params_vertical_align: 0.5,  // ✨ 参数也靠近顶部（默认 0.7）

          // ✨ 字体大小配置（可选）
          font_size: 0.22,                // 基础字体大小（基于条高的比例，默认 0.16）
